...
GameObject::GameObject(void):
	...
	m_ToKillComponents{}, m_ToAddComponents{}
{
...
void GameObject::RootUpdate(const GameContext& gameContext)
{
	...
	//Kill Pending Components
	KillPendingComponents();
...
void GameObject::PendToAddComponent(BaseComponent* pComp)
{
	m_ToAddComponents.push_back(pComp);
}
...
void GameObject::PendToRemoveComponent(BaseComponent* pComp)
{
	m_ToKillComponents.push_back(pComp);
}
...
void GameObject::KillPendingComponents()
{
	for (BaseComponent* pComp : m_ToKillComponents)
	{
		RemoveComponent(pComp);
	}
	m_ToKillComponents.clear();
}

void GameObject::AddPendingComponents()
{
	for (BaseComponent* pComp : m_ToAddComponents)
	{
		AddComponent(pComp);
	}
