...
public:
	...
	void PendToAddComponent(BaseComponent* pComp);
	void RemoveComponent(BaseComponent* pComp);
	void PendToRemoveComponent(BaseComponent* pComp);
...
private:
	...
	vector<BaseComponent*> m_ToKillComponents;
	void KillPendingComponents();

	vector<BaseComponent*> m_ToAddComponents;
